...
ActiveRecord::Schema.define(version: 20150408201701) do
  ...
  add_index "shortened_urls", ["submitter_user_id"], name: "index_shortened_urls_on_submitter_user_id", using: :btree
  ...
  add_index "visits", ["visitor_user_id"], name: "index_visits_on_visitor_user_id", using: :btree
